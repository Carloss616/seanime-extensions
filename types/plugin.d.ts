...
interface DOMManager {
    ...
    queryOne(selector: string, opts?: Record<string, any>): Promise<DOMElement | null>
    observe(
        selector: string,
...
interface PluginContext {
    ...
    registerEventHandler(id: string, callback: (event?: any) => void | Promise<void>): void
    /** Inline event handler with a unique id per element. Returned value is
     *  passed as the onClick of a tray component. */
    eventHandler(uniqueId: string, callback: (event?: any) => void | Promise<void>): unknown
...
interface Tray {
    ...
    img(opts: { src: string; alt?: string; className?: string; style?: Record<string, string> }): unknown
